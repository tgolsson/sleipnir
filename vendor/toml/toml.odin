...
get_i64 :: proc(section: ^Table, path: ..string) -> (val: i64, ok: bool) {return get(
		i64,
		section,
		..path,
	)}
get_f64 :: proc(section: ^Table, path: ..string) -> (val: f64, ok: bool) {return get(
		f64,
		section,
		..path,
	)}
get_bool :: proc(section: ^Table, path: ..string) -> (val: bool, ok: bool) {return get(
		bool,
		section,
		..path,
	)}
get_string :: proc(section: ^Table, path: ..string) -> (val: string, ok: bool) {return get(
		string,
		section,
		..path,
	)}
...
get_list :: proc(section: ^Table, path: ..string) -> (val: ^List, ok: bool) {return get(
		^List,
		section,
		..path,
	)}
get_table :: proc(section: ^Table, path: ..string) -> (val: ^Table, ok: bool) {return get(
		^Table,
		section,
		..path,
	)}

get_i64_panic :: proc(section: ^Table, path: ..string) -> i64 {return get_panic(
		i64,
		section,
		..path,
	)}
get_f64_panic :: proc(section: ^Table, path: ..string) -> f64 {return get_panic(
		f64,
		section,
		..path,
	)}
get_bool_panic :: proc(section: ^Table, path: ..string) -> bool {return get_panic(
		bool,
		section,
		..path,
	)}
get_string_panic :: proc(section: ^Table, path: ..string) -> string {return get_panic(
		string,
		section,
		..path,
	)}
get_date_panic :: proc(section: ^Table, path: ..string) -> dates.Date {return get_panic(
		dates.Date,
		section,
		..path,
	)}
get_list_panic :: proc(section: ^Table, path: ..string) -> ^List {return get_panic(
		^List,
		section,
		..path,
	)}
get_table_panic :: proc(section: ^Table, path: ..string) -> ^Table {return get_panic(
		^Table,
		section,
		..path,
	)}
